...
Retrieves a [Page object](https://developers.notion.com/notionapi/reference/page) using the ID specified.
      ...
      "get": {
        ...
        "parameters": [
          ...
          },
          {
            ...
            "in": "query",
            "description": "A list of page property value IDs or property names associated with the page. Use this param to limit the response to a specific page property value or values. To retrieve multiple properties, specify each. For example: ?filter_properties=iAk8&filter_properties=b7dh.",
            "schema": {
              "type": "string"
            }
          },
